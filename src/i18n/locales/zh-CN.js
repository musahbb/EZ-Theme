...
export default {
    ...
    dashboard: {
        ...
        resetDataCycleNotice:'点击「我知道了」将会扣除当前流量周期剩余订阅时长，系统将会重置您的已使用流量，如开启失败请刷新页面后重试，或者更换浏览器。',
        nextPeriodError:'提前开启下月失败',
        nextPeriodSuccess:'提前开启下月成功',
        renewPlan: '续费套餐',
        noPlanToRenew: '没有可续费的套餐',
        resetTrafficConfirm: '确认重置流量',
        resetTrafficDesc: '此操作将重置已使用的流量但不会增加套餐时长，如果剩余时间少，建议续费套餐后点击「提前开启流量周期」',
